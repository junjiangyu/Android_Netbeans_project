    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState){
        ...
        loginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                RegisterFragment func = new RegisterFragment();
                username = name.getText().toString();
                //using the hash function inside registerfrag to hash password
                try {
                    password = func.hash(pwd.getText().toString());
    ...
    private class AccountAsyncTask extends AsyncTask<Void, Void, String>
    {
        ...
        if(account.equals("[]")){
            ...
            if (password.equals(correctpassword)){
                ...
                myIntent.putExtra("userinfo",account);
